...
<header class="continer-fluid ">
 ...
 <!--  ************************* Gallery Starts Here ************************** -->
        ...
        <div class="gallery-filter d-none d-sm-block">
            ...
            <button class="btn btn-default filter-button" data-filter="hdpe">Covid Relief</button>
            <button class="btn btn-default filter-button" data-filter="sprinkle">Orphanage Visits</button>
            <button class="btn btn-default filter-button" data-filter="spray">Items Distributions</button>
            <button class="btn btn-default filter-button" data-filter="irrigation">Education Projects</button>
        </div>
        <br/>
